...
<form class="bg-grey dark:bg-reallydarkgrey grid place-items-center p-4 border border-black dark:border-grey rounded-md break-words w-lg max-w-lg" on:submit|preventDefault={addItem}>
    ...
    <label class="text-darkgrey my-2 dark:text-grey" for="link">Link to product page:</label>
    <input type="text" name="link" id="link" placeholder="link" required class="border-darkgrey border-2 bg-grey rounded-md p-1 pl-2 dark:bg-extradarkgrey dark:text-grey dark:border-grey" />
    <label class="text-darkgrey my-2 dark:text-grey" for="img">Image url (must be from imgbb, cubeupload, or amazon):</label>
